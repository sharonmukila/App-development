...
//        List<LoginResponse> userList = userService.getAllUsers();
...
//        LoginResponse userResponse = userService.getUser(uid);
...
//        LoginResponse userResponse = userService.updateUser(request, uid);
//        return userResponse != null ? ResponseEntity.ok().body(userResponse) : ResponseEntity.notFound().build();
//    }
//
